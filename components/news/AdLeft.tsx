...
const AdLeft = () => (
  <aside className="lg:flex flex-col items-center w-56 min-h-[400px] bg-white border-r border-slate-200 shadow-md rounded-r-2xl p-4 mt-8 gap-4">
    {adData.slice(0, Math.ceil(adData.length / 2)).map((ad, idx) => (
